...
st.markdown("""
### 사용 안내
1.  **영상 테마**를 선택하고, 고인을 추억하는 **글**을 작성해주세요.
2.  영상에 사용할 **사진**과 배경으로 쓰일 **음악 또는 음성 파일**을 업로드하세요.
3.  '**영상 제작 시작하기**' 버튼을 누르면 AI 에이전트들이 협력하여 자동으로 영상을 만듭니다.
4.  완성된 영상은 화면에서 바로 확인하고 **다운로드**할 수 있습니다.
""")